      ...
      ResponsiveTabs = (function () {
        function ResponsiveTabs() {
          ...
          var update_tabs = function () {
            ...
            TABS_OBJECT.tabsVerticalContainer.siblings(".dropdown-toggle").find(".count").text("More");
          ...
          var setup = function () {
            ...
            TABS_OBJECT.tabsHorizontalContainer.after("<div class='nav navbar-nav navbar-right dropdown tabs-dropdown js-tabs-dropdown'> \
              <a href='#' class='dropdown-toggle' data-toggle='dropdown'><span class='count'>More </span><b class='caret'></b></a> \
